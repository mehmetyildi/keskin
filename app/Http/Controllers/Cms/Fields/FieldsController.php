...
namespace App\Http\Controllers\Cms\Fields;

use Illuminate\Http\Request;
use App\Http\Controllers\Cms\BaseController;
use App\Models\Field as PageModel;
...
class FieldsController extends BaseController
{
    ...
    public function __construct(PageModel $model)
    {
        ...
        $this->pageUrl = 'fields';
        $this->pageName = 'Uygulama Alanları';
        $this->pageItem = 'Uygulama Alanı';
    ...
    public function create()
    {
        ...
        return view('cms.'.$this->pageUrl.'.create',compact('products'));
    }
    ...
    public function edit(PageModel $record)
    {
        ...
        checkPermissionFor('edit_content');
        $products=Product::pluck('title_tr','id')->all();
        return view('cms.'.$this->pageUrl.'.edit', compact('record','products'));
    }
