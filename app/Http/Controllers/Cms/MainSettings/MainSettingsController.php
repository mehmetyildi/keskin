...
namespace App\Http\Controllers\Cms\MainSettings;

use Illuminate\Http\Request;
use App\Http\Controllers\Cms\BaseController;
use App\Models\MainSetting as PageModel;
use App\Models\Cms\SearchIndex;
use View;
use File;

class MainSettingsController extends BaseController
{
    /**
    ...
    public function __construct(PageModel $model)
    {
        ...
        $this->pageUrl = 'main-settings';
        $this->pageName = 'Genel Ayarlar';
        $this->pageItem = 'Genel Ayar';
        $this->urlColumn = 'opening_video';
        $this->hasUrl = false;
