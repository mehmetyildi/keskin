...
@section('title') <title>{{ config('app.cms_name') }} | Yanıtla</title> @endsection
        ...
        <div class="col-lg-9 animated fadeInRight">
            <div class="mail-box-header">
                <div class="pull-right tooltip-demo">
                    ...
                    <a href="{{ route('cms.inbox.index') }}" class="btn btn-default btn-sm" data-toggle="tooltip" data-placement="top" title="İptal et"><i class="fa fa-times"></i> İptal Et</a>
                </div>
                <h2>
                    Yanıtla
                </h2>
            ...
            <div class="mail-box">
                <form class="form-horizontal" id="composerForm" method="POST" action="{{ route('cms.inbox.send') }}">
                    ...
                    <div class="mail-body">
                        ...
                        <div class="form-group"><label class="col-sm-2 control-label">Kaydet:</label>

                            <div class="col-sm-10"><input type="text" class="form-control" name="subject" required value="Ynt: {{ $mail->subject }}"></div>
                        </div>
                    </div>
                    <div class="mail-text h-200">
                        ...
                        <div class="col-lg-12">
                            <br><br>
                            <hr>
                            <small>Orjinal Mesaj {{ $mail->created_at->format('d.m.y @ h:i') }}</small>
                            <hr>
                            {!! $mail->body !!}
                            <br>
                        </div>
                    ...
                    <div class="mail-body text-right tooltip-demo">
                        <button type="submit" class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="top" title="Yanıtla"><i class="fa fa-reply"></i> Yanıtla</button>
                    </div>
                </form>
                <div class="clearfix"></div>
            </div>
