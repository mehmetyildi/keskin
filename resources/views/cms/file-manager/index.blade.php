            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content">
                    <div class="file-manager">
                        ...
                        <a class="file-control ">Son Eklenenler</a>
                       ...
                       <!--  <button class="btn btn-primary btn-block">Upload Files</button>
                        ...
                        <ul class="folder-list" style="padding: 0">
                            ...
                            <li><a href="{{ route('cms.file-manager.detail', ['folder' => $fold->id]) }}"><i class="fa fa-folder"></i> {{ $fold->title }}</a></li>
                            @endforeach
                        </ul>
        	...
        	<div class="ibox float-e-margins">
                <div class="ibox-content">
                    <div class="file-manager">
                        <h5>EN SON...</h5>
                        <div class="hr-line-dashed"></div>
                        <a class="file-control "> Yüklediğiniz son 15 dosya</a>
                    </div>
                </div>
            </div>
            <div class="row">
